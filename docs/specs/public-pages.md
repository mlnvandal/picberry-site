...
The website provides the public privacy and support information for Picberry. It is a small static GitHub Pages site with no app backend, visitor accounts, forms, client-side scripts, analytics, external fonts, or cookies set by the site.
